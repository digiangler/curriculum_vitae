...
2011年に脱サラして、2019にシステムエンジニアの血が騒ぎ出し、ふたたびカムバック。現在は最新のプログラミング言語や技術を学びながら、案件やポートフォリオを作成しながらソフトウェアエンジニア兼ウェブデザイナーとライターのフルスタックを楽しんでいます。
