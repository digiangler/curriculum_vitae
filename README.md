...
現在は、ソフトウェアエンジニア（フルスタック開発者）として、さｍな案件を好きな仲間と開発したり、オリジナルのウェブサイトやアプリをつくって運営すること（サブスク）も考えております。
...
Dreamweaverなどの有料エディターやフリーエディターによる手打ちの経験があり、新規サイトはもちろん既存サイトのソースコードを読み、そのシステムと連携させるためのウェブデザインとコーディングもできます。更新作業も多いときは、月平均300ページのコンテンツをアップロードしました。Photohop、Illustratorの使用経験は、業務・プライベートの両方で画像の編集、アイコンなどの作成をしているため基本操作は大丈夫です（現在は一切使用していませんので微妙かも）。
